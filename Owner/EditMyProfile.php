...
<div class="mb-1">
    ...
    <div class="row mt-3">
        ...
        <input class="col-6" style="padding: 10px; border: 1px solid #828282; 
        border-radius: 10px; background: #fff; box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.5);"></div>
    </input>
        ...
        <div>
            <a style="color: #FFF;" href="#.php">
                    ...
                    style="         color: #FFF;
                                    ...
                                    padding:10px;
                                    font-size:20px;">ยืนยัน</button></a>
            ...
            <a style="color: #FFF;" href="#.php">
                    ...
                    style="         color: #FFF;
                                    ...
                                    box-shadow: 5px 4px 13.5px 0px rgba(0, 0, 0, 0.25);
                                    padding:10px;
                                    font-size:20px;">ยกเลิก</button></a>
</div>
